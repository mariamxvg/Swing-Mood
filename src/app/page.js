    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-5xl flex flex-col items-center">
          ...
          >
            From intimate private gatherings to full-scale experiences, we design and execute every detail. Music, artists, lighting, atmosphere, concept, and production — from idea to reality. Whatever you imagine, we bring to life.
          </motion.p>
    ...
    <h2 className="text-3xl md:text-5xl tracking-[0.4em] text-white leading-relaxed">
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-3xl flex flex-col items-center">
          ...
          >
            Swing Mood is built on the belief that every moment carries a feeling — and that feeling can be designed. <br /><br />
            We craft experiences where music, lighting, space, and energy come together to create something unforgettable. <br /><br />
